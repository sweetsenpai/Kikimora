...
class TestAdminProdactListView:
    def test_get_productlist(self, client, admin_user, products_set_1, subcategories, category):
        ...
        url = reverse('product_list', kwargs={'category_id':category.category_id,
    ...
    def test_not_admin_get_productlist(self, client, regular_user, products_set_1, subcategories, category):
