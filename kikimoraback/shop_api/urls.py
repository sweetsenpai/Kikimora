...
# API
    ...
    path('api/v1/verify-email/<str:token>/', VerifyEmailView.as_view(), name='verify-email'),
    # USER DATA
    ...
    path('api/v1/autocomplete/product/', ProductAutocompleteView.as_view(), name='product-autocomplete-api'),
    path('api/v1/menu/subcategory/', MenuSubcategory.as_view(), name='sub-menu'),
    path('api/v1/menu/discount_product_menu/<int:subcategory_id>/', DiscountCreationRelatedProducts.as_view(), name='prod-disc-menu'),
    # PRICE CHANGERS
    path('api/v1/discount', DiscountProductActiveList.as_view(), name='api-discount'),
    path('api/v1/discounts/stop/<int:discount_id>/', StopDiscountView.as_view(), name='stop_discount_api'),
    path('api/v1/limitproduct', LimitProduct.as_view(), name='api-limitproduct'),
    # CRM WORK
    path('api/v1/delete_day_product/<int:limittimeproduct_id>/', DeleteDayProduct.as_view(), name='delete_day_product'),
    # CART
