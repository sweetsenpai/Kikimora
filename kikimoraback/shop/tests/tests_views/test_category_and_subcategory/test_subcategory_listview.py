...
class TestSubcategoryListView:
    ...
    def test_get_subcategory_non_existing_category(
        self, client, admin_user, subcategories
    ):
        client.force_login(admin_user)
    ...
    def test_get_subcategory_page_not_admin(
        self, client, regular_user, subcategories, category
    ):
