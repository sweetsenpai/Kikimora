...
from kikimoraback.shop.models import Category, Discount, Product, Subcategory
...
class DiscountFormTest(TestCase):
    ...
    def setUp(self):
        ...
        self.product = Product.objects.create(
            name="Product 1", subcategory=self.subcategory, photo_url="1111"
        )
    ...
    def test_form_invalid_with_percentage_over_100(self):
        ...
        self.assertEqual(
            form.errors["value"][0], "Процент скидки не может быть больше 100!"
        )
